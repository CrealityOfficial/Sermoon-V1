...
#define Var_light   0x20
#define Var_time    0xEA60
...
/* Manual level */
#define X_MANUAL_LEVEL_SIZE 165
#define Y_MANUAL_LEVEL_SIZE 165
#define X_MANUAL_OFFSET (X_BED_SIZE - X_MANUAL_LEVEL_SIZE)
#define Y_MANUAL_OFFSET (Y_BED_SIZE - Y_MANUAL_LEVEL_SIZE)
...
/*Sermoon V1 add address*/
#define POWERON_ICON_VP                 0x1400
#define CHECKDOOR_ICON_VP               0x1401
#define PRINT_HEITH_VP                  0x1402
#define ZOFFSET_DATA_VP                 0x1404
#define WIFI_ICON_VP                    0x1406
#define BOXFAN_ICON_VP                  0x1407
#define WIFILED_ICON_VP                 0x1408
...
// #define PoweOn_VP                       0x134C
#define CheckDoor_VP                    0x134D
#define Window_done_VP                  0x134E
#define Box_fan_VP                      0x134F
#define WIFI_LED_VP                     0x1350
...
class RTSSHOW {
  public:
    ...
    void RTS_Backlight(unsigned short = Var_light, unsigned short = Var_time);
...
extern void ZaxisMoveToZMax(void);
extern void RTS_line_to_current(AxisEnum axis);
extern float offset_negative_001(float cmd);

extern millis_t start_print_time;
