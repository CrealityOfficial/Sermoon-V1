...
#define STR_M115_DISABLE_REPORT             "FIRMWARE_NAME:Marlin "                         DETAILED_BUILD_VERSION \
                                            " (" __DATE__ " " __TIME__ ") SOURCE_CODE_URL:" SOURCE_CODE_URL \
                                            " PROTOCOL_VERSION:"                            PROTOCOL_VERSION \
                                            " MACHINE_TYPE:"                                MACHINE_NAME \
                                            " EXTRUDER_COUNT:"                              STRINGIFY(EXTRUDERS) \
                                            " UUID:"                                        MACHINE_UUID\
                                            " Cap:WIFI:"                                    STRINGIFY(0)
#define STR_M115_ENABLE_REPORT              "FIRMWARE_NAME:Marlin "                         DETAILED_BUILD_VERSION \
                                            " (" __DATE__ " " __TIME__ ") SOURCE_CODE_URL:" SOURCE_CODE_URL \
                                            " PROTOCOL_VERSION:"                            PROTOCOL_VERSION \
                                            " MACHINE_TYPE:"                                MACHINE_NAME \
                                            " EXTRUDER_COUNT:"                              STRINGIFY(EXTRUDERS) \
