  ...
  switch (state) {
    ...
    case MeshNext:
      ...
      if (mbl_probe_index == 0) {
        ...
        // mbl.set_zigzag_z(mbl_probe_index - 1, (current_position.z-0.1));//caixiaoliang modify 20210414
      ...
      if (mbl_probe_index < GRID_MAX_POINTS) {
        ...
        #ifdef RTS_AVAILABLE
          #if 0
          rtscheck.RTS_SndData(mbl_probe_index + 1, ManualBedLevelRefreshPictureAdr);//切换下一个调平点界面
          rtscheck.RTS_SndData(current_position.z * 100, CompensationZoffsetValueAdr);
          #endif
        #endif         
      }
      else {
        ...
        TERN_(LCD_BED_LEVELING, ui.wait_for_move = false);
          ...
          else
          {
            ...
            for(int y = 0;y < GRID_MAX_POINTS_Y;y++)
            {
              ...
              {
                rtscheck.RTS_SndData(mbl.z_values[x][y]*1000, AutolevelVal + showcount*2);
                showcount++;
              }
            }
          #endif
